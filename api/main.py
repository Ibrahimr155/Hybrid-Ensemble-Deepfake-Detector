...
# 1. project/frontend/index.html
# 2. project/backend/index.html or the same folder as this main.py
INDEX_CANDIDATES = [
...
def root():
    ...
    return {
        "message": "Frontend index.html not found. Put index.html in the frontend folder or in the same folder as main.py.",
        "checked_paths": INDEX_CANDIDATES,
    }
